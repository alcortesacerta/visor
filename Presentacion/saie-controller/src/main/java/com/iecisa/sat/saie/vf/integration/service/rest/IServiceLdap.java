...
public interface IServiceLdap {
	...
	ServiceResponse<List<String>> getRolesLdap(ConsultaLdapRequestDTO paramConsultaLdapRequestDTO);
}
 ...
 * saie\vf\integration\service\rest\IServiceLdap.class Java compiler version: 8
