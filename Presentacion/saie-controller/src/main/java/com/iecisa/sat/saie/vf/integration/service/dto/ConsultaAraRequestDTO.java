...
/*    */
/*    */
/*    */ public class ConsultaAraRequestDTO
/*    */ {
	/*    */ private String numeroSerie;

	/*    */
	/* 9 */ public ConsultaAraRequestDTO(String numeroSerie) {
	...
	/*    */
	/*    */
	/* 13 */ public String getNumeroSerie() {
	...
	/*    */
	/*    */
	/* 17 */ public void setNumeroSerie(String numeroSerie) {
		this.numeroSerie = numeroSerie;
	}
	/*    */ }
 ...
 * saie\vf\integration\service\dto\ConsultaAraRequestDTO.class Java compiler
